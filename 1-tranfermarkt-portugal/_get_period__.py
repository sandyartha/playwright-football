...
CLUB_ALIASES = {
  "avs futebol": ["avs", "os aurinegros", "the gold and blacks"],
  ...
  "cf estrela amadora": ["estrela amadora", "os tricolores", "the tricolors"],
  ...
  "vitória guimarães sc": ["vitória guimarães", "os conquistadores", "the conquerors"]
}
