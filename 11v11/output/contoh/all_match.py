...
def proses_file_csv(file_path):
    ...
    df[['Skor Tim 1', 'Skor Tim 2']] = df['Score'].str.split('-', expand=True)

    # Mengubah tipe data skor menjadi integer
    df['Skor Tim 1'] = df['Skor Tim 1'].astype(int)
    df['Skor Tim 2'] = df['Skor Tim 2'].astype(int)
